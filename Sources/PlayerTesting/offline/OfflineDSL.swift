...
public func startOfflineTest(
    ...
    OfflineWorld.sharedWorld.startOfflineTest(
...
public func callOfflineContentManagerAndExpectEvent<T: OfflineEvent>(
    ...
    OfflineWorld.sharedWorld.callOfflineContentManagerAndExpectEvent(
...
public func callOfflineContentManagerAndExpectEvents(
    ...
    OfflineWorld.sharedWorld.callOfflineContentManagerAndExpectEvents(
        offlineContentManager,
        offlineContentManagerBlock,
...
public func expectEvent<T: OfflineEvent>(
    ...
    OfflineWorld.sharedWorld.expectEvent(
        offlineContentManager,
        eventClass,
        timeout: timeout,
        file: file,
...
public func expectEvents(
    ...
    OfflineWorld.sharedWorld.expectEvents(
        offlineContentManager,
...
public func rejectEvent<T: OfflineEvent>(
    ...
    OfflineWorld.sharedWorld.rejectEvent(
        offlineContentManager,
        file: file,
        line: line,
        eventClass,
...
public func rejectEvents(
    ...
    OfflineWorld.sharedWorld.rejectEvents(
        offlineContentManager,
        file: file,
        line: line,
        multipleEventExpectation,
...
public func getOfflineContentManager(
    ...
    try OfflineWorld.sharedWorld.getOfflineContentManager(
        sourceConfig: sourceConfig,
        id: id,
        clean: clean
    )
...
public func downloadUntilProgress(
    ...
    OfflineWorld.sharedWorld.downloadUntilProgress(
        offlineContentManager,
        progress: progress,
        timeout: timeout,
        file: file,
...
public func waitUntilDownloaded(
    ...
    OfflineWorld.sharedWorld.waitUntilDownloaded(
        offlineContentManager,
        tracks: tracks,
        config: config,
        timeout: timeout,
